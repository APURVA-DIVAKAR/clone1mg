          ...
          <div style={{ display: "flex", justifyContent: "space-around" }}>
            ...
            <div className="style__main-link-bar___12igi">
              ...
              <ul>
                ...
                <li>
                  <button className="style__signup-btn___2h_dH ">
                    SIGN UP
                  </button>
                </li>
              </ul>
          ...
          <div className="style__b-text___uV-wn">
            <div>
              <p className="style__copyright___qclAW">
                © 2022 Tata 1mg. All rights reserved. In compliance with Drugs
                and Cosmetics Act, 1940 and Drugs and Cosmetics Rules, 1945, we
                don't process requests for Schedule X and other habit forming
                drugs.
              </p>
            </div>
